...
import cied.in.Utz.Adapter.AllAuditAdapter;
...
public class AllAuditFragment extends  Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(commonAuditDetails.size() == 0)
        {
            ...
            textView.setText("No Audits Obtained..");
        }
        else
        {
        ...
        AllAuditAdapter allAuditAdapter = new AllAuditAdapter(getActivity(),commonAuditDetails);
        recyclerView.setAdapter(allAuditAdapter);
        return view;
