...
import cied.in.Utz.MainActivity;
 ...
 */
public class AllAuditAdapter extends RecyclerView.Adapter<AllAuditAdapter.MyViewHolder> {
    ...
    public AllAuditAdapter(Context context,List<Items> list) {
        this.auditDetailsList = list;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if(auditDetailsList.get(position).getCategory().equals("singleaudit"))
        {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    Log.e("auditId....",""+auditDetailsList.get(position).getAuditId());
                    mcontext.startActivity(intent);
                }
            }
        });
